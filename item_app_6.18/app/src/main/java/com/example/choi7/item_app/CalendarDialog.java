...
//갤린더 생성
        ...
        import static com.example.choi7.item_app.Layout_one.mqtt;
...
public class CalendarDialog extends Dialog implements View.OnClickListener,
    ...
    private void doneClick() {
        ...
        Log.e("데이즈", "첫 날 :" + selectedDays.get(0).toString());
        Log.e("데이즈", "마지막 날 :" + selectedDays.get(calendarView.getSelectedDays().size()-1).toString());

        Log.d("개수", "" + calendarView.getSelectedDays().size());

        Layout_one.count = calendarView.getSelectedDays().size();

        String First_day = selectedDays.get(0).toString();
        String Last_day = selectedDays.get(calendarView.getSelectedDays().size()-1).toString();

        String[] split_First_day = First_day.split(" ");
        String[] split_Last_day = Last_day.split(" ");

        Layout_one.selected_First_day = new StringBuilder(split_First_day[5].substring(0,4));
        Layout_one.selected_Last_day = new StringBuilder(split_Last_day[5].substring(0,4));


        Layout_one.selected_First_day.append("-");
        if(Last_day.contains("Jan"))
            Layout_one.selected_First_day.append("01-");
        else if(Last_day.contains("Feb"))
            Layout_one.selected_First_day.append("02-");
        else if(Last_day.contains("Mar"))
            Layout_one.selected_First_day.append("03-");
        else if(Last_day.contains("Apr"))
            Layout_one.selected_First_day.append("04-");
        else if(Last_day.contains("May"))
            Layout_one.selected_First_day.append("05-");
        else if(Last_day.contains("Jun"))
            Layout_one.selected_First_day.append("06-");
        else if(Last_day.contains("Jul"))
            Layout_one.selected_First_day.append("07-");
        else if(Last_day.contains("Aug"))
            Layout_one.selected_First_day.append("08-");
        else if(Last_day.contains("Sep"))
            Layout_one.selected_First_day.append("09-");
        else if(Last_day.contains("Oct"))
            Layout_one.selected_First_day.append("10-");
        else if(Last_day.contains("Nov"))
            Layout_one.selected_First_day.append("11-");
        else if(Last_day.contains("Dec"))
            Layout_one.selected_First_day.append("12-");

        Layout_one.selected_First_day.append(split_First_day[2]);
        Log.e("데이즈", "첫 날 :" + Layout_one.selected_First_day);


        Layout_one.selected_Last_day.append("-");
        if(Last_day.contains("Jan"))
            Layout_one.selected_Last_day.append("01-");
        else if(Last_day.contains("Feb"))
            Layout_one.selected_Last_day.append("02-");
        else if(Last_day.contains("Mar"))
            Layout_one.selected_Last_day.append("03-");
        else if(Last_day.contains("Apr"))
            Layout_one.selected_Last_day.append("04-");
        else if(Last_day.contains("May"))
            Layout_one.selected_Last_day.append("05-");
        else if(Last_day.contains("Jun"))
            Layout_one.selected_Last_day.append("06-");
        else if(Last_day.contains("Jul"))
            Layout_one.selected_Last_day.append("07-");
        else if(Last_day.contains("Aug"))
            Layout_one.selected_Last_day.append("08-");
        else if(Last_day.contains("Sep"))
            Layout_one.selected_Last_day.append("09-");
        else if(Last_day.contains("Oct"))
            Layout_one.selected_Last_day.append("10-");
        else if(Last_day.contains("Nov"))
            Layout_one.selected_Last_day.append("11-");
        else if(Last_day.contains("Dec"))
            Layout_one.selected_Last_day.append("12-");

        Layout_one.selected_Last_day.append(split_Last_day[2]);
        Log.e("데이즈", "마지막 날 :" + Layout_one.selected_Last_day);
